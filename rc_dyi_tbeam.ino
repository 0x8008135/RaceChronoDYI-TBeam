//Library for U-blox GPS (https://github.com/bolderflight/UBLOX)
#include <UBLOX.h>
...
struct ublox {
    uint8_t message_class;      //Message Class (NAV,...)
    uint8_t message_id;         //Message ID
    uint16_t payload_length;    //Payload length (w/o header and checksum)
};
